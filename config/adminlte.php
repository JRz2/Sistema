...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Distribuidores',
            'route'  => 'admin.distribuidor.index',
            'icon' => 'fas fa-solid fa-id-badge',
            'can' => 'admin.distribuidor.index'
        ],
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'General',
                    'route'  => 'admin.despacho.index',
                    'can' => 'admin.despacho.index'
                ],
                [
                    'text' => 'Super Mercados',
                    'route'  => 'admin.supermarket.index',
                    'can' => 'admin.supermarket.index'
                ],
            ],
        ],
        [
            'text' => 'Planta',
            'route'  => 'admin.prueba.index',
            'icon' => 'fas fa-industry', 
            'can' => 'admin.prueba.index'
        ],
       // [
       //     'text' => 'Inventarios',
