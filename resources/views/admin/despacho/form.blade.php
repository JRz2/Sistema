<div id="boton">
    {!! Form::submit('Guardar Nota', ['class'=> 'btn btn-success', 'id'=>'agrega']) !!}
</div>
<div class="container" style="margin-bottom: 100px;">
    ...
    <div class="form-row">
        ...
        <div class="col-md-3 mb-3">
            ...
            {!! Form::number('entradacanasta', null, ['class'=> 'form-control', 'placeholder'=>'Entrada Canastillos','min'=>'0', 'max'=>'100', 'required'])!!}
            <div class="valid-feedback">
                Looks good!
            </div>
        </div>
        ...
        <div class="col-md-3 mb-3">
            ...
            {!! Form::number('salidacanasta', null, ['class'=> 'form-control', 'placeholder'=>'Salida Canastillos','min'=>'0', 'max'=>'100', 'required']) !!}
            <div class="valid-feedback">
                Looks good!
            </div>
        </div> 
...
<div class="card" style="margin-bottom: 0px;">
    <h4 id="producto">AGREGAR PRODUCTOS</h4>
    <div class="form-row">
        <div class="col-md-3 mb-3">
    ...
    <div class="form-group">
        <button id="agregar" type="button" class="btn btn-secondary">AGREGAR PRODUCTO</button>
    </div>
    <div class="form-row">
