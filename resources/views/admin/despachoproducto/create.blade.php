<a class="btn btn-primary" data-toggle="modal" data-target="#editModal" href="{{route('admin.despachoproducto.create')}}">AGREGAR PRODUCTO</a> 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          {!! Form::open(['route'=> 'admin.despachoproducto.store']) !!} 
            <div class="form-group">
              {!! Form::hidden('despacho_id', $despacho->id) !!}
                  @error('codigo')
