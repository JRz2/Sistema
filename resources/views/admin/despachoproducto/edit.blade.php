<a class="btn btn-primary" data-toggle="modal" data-target="#editModal{{$despachoproducto->id}}" href="{{route('admin.despachoproducto.edit', $despachoproducto)}}">Editar</a>  
<div class="modal fade" id="editModal{{$despachoproducto->id}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-body">
          {!! Form::model($despachoproducto,['route'=> ['admin.despachoproducto.update', $despachoproducto], 'method'=>'put']) !!}
            <div class="form-group">
              {!! Form::text('despacho_id', null, ['class'=> 'form-control','hidden']) !!}
                @error('codigo')
