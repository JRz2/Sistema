<a class="btn btn-primary" data-toggle="modal" data-target="#editModal" href="{{route('admin.plantaproducto.create')}}">AGREGAR PRODUCTO</a> 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          {!! Form::open(['route'=> 'admin.plantaproducto.store']) !!} 
            <div class="form-group">
              {!! Form::hidden('planta_id', $prueba->id) !!}
                  @error('codigo')
