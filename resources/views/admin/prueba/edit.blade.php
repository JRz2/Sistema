...
@section('content')
    <div class="container">
        ...
        <div class="car-body">
            {!! Form::model($prueba,['route'=> ['admin.prueba.update', $prueba], 'method'=>'put']) !!}
...
<br>
<br>
            @include('admin.plantaproducto.create', [$prueba])
            ...
            <table id="usuarios" class="table table-striped">
                ...
                <tbody>
                    ...
                    @if ($plantaproducto->planta_id == $prueba->id)
                        <tr>
                            ...
                            <td width="100px">
                                @csrf
                                @include('admin.plantaproducto.edit')
                            </td>
                            <td width="100px">
