...
<body>
    ...
    <div class="logos">
        <div class="l1">
            <img src="vendor/adminlte/dist/img/ketal.png"  class="log">
        </div>
        <div class="l2">
            <img src="vendor/adminlte/dist/img/hiper.png" class="log">
        </div>
        <div class="l3">
            <img src="vendor/adminlte/dist/img/facil.png" class="log">
        </div>
        <div class="l4">
            <table>
                <thead>
                    <th rowspan="2">Supermercado</th>
                    <th class="thsuper">Ketal S.A</th>
                    <th class="thsuper">Hipermaxi S.A.</th>
                </thead>
                <tbody>
                    <tr>
                        <td></td>
    ...
    <div class="body">
        <table class="tc">
            ...
            @if($desp->id==$deta->supermarket_id)
                    <tr>
                        <td>{{$deta->id}}</td>
