<a class="btn btn-primary" data-toggle="modal" data-target="#editModal" href="{{route('admin.supermarketproducto.create')}}">AGREGAR PRODUCTO</a> 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            {!! Form::open(['route'=> 'admin.supermarketproducto.store']) !!}  
            <div class="form-group">
              {!! Form::hidden('supermarket_id', $supermarket->id) !!}
                  @error('codigo')
          ...
          <div class="modal-footer">
            ...
            {!! Form::submit('Guardar Producto', ['class'=> 'btn btn-primary', 'id'=>'actualizar']) !!} 
          </div>
          {!! Form::close() !!} 
      </div>
    </div>
